import pygame
pygame.mixer.init()
pygame.mixer.music.load('D:\\NSBM\\Python Projects\\fun\\avengers\\py09\\avengers.mp3')
...
if __name__ == '__main__':
    ...
    avengers.write("Test Run By Ravishka")
    avengers.hideturtle
    avengers.color('white')
    avengers.setposition(200, -100)
    avengers.write('VENGERS',font = ('Courier',115,'bold'))
    turtle.done()